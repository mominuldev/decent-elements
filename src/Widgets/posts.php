 ...
 * @since 1.0.0
 */
class Decent_Elements_Post_Widget extends Widget_Base
{
	...
	{
		return esc_html__('Posts', 'decent-elements');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'preset_layout',
			[
				'label'   => esc_html__('Style', 'decent-elements'),
				'type'    => Controls_Manager::SELECT,
				'default' => '1',
				'options' => [
					'1'  => esc_html__('One', 'decent-elements'),
					'2'  => esc_html__('Two', 'decent-elements'),
					'3'  => esc_html__('Three', 'decent-elements'),
					'4'  => esc_html__('Four', 'decent-elements'),
					'5'  => esc_html__('Five', 'decent-elements'),
					'6'  => esc_html__('Six', 'decent-elements'),
					'7'  => esc_html__('Seven', 'decent-elements'),
					'8'  => esc_html__('Eight', 'decent-elements'),
					'9'  => esc_html__('Nine', 'decent-elements'),
					'10' => esc_html__('Ten', 'decent-elements'),
				],
			]
		);
		...
		$this->add_responsive_control(
			'columns',
			[
				'label'          => esc_html__('Columns', 'decent-elements'),
				'type'           => Controls_Manager::SELECT,
		...
		$this->add_control(
			'posts_per_page',
			[
				'label'   => esc_html__('Posts Per Page', 'decent-elements'),
		...
		$this->add_control(
			'image_position',
			[
				'label'     => esc_html__('Image Position', 'decent-elements'),
		...
		$this->add_control(
			'show_title',
			[
				'label'     => esc_html__('Show Title', 'decent-elements'),
		...
		$this->add_control(
			'title_length',
			[
				'label'     => esc_html__('Title Length (words)', 'decent-elements'),
				'type'      => Controls_Manager::NUMBER,
				'min'       => 5,
				'max'       => 100,
				'condition' => [
		...
		$this->add_control(
			'title_length_line',
			[
				'label'     => esc_html__('Title Length (lines)', 'decent-elements'),
				'type'      => Controls_Manager::NUMBER,
				'min'       => 1,
				'max'       => 5,
				'default'   => 2,
		...
		$this->add_control(
			'title_tag',
			[
				'label'     => esc_html__('Title HTML Tag', 'decent-elements'),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'h1'   => 'H1',
					'h2'   => 'H2',
		...
		$this->add_control(
			'show_excerpt',
			[
				'label'     => esc_html__('Show Excerpt', 'decent-elements'),
				'type'      => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'excerpt_length',
			[
				'label'     => esc_html__('Excerpt Length', 'decent-elements'),
				'type'      => Controls_Manager::NUMBER,
				'min'       => 5,
				'max'       => 100,
				'default'   => 14,
		...
		$this->start_controls_section(
			'section_meta',
			[
				'label' => esc_html__('Meta', 'decent-elements'),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'meta_style',
			[
				'label'   => esc_html__('Meta Type', 'decent-elements'),
				'type'    => Controls_Manager::SELECT,
				'default' => 'box',
				'options' => [
					'box'         => esc_html__('Box', 'decent-elements'),
					'inline'      => esc_html__('Inline', 'decent-elements'),
					'inline-icon' => esc_html__('Inline Icon', 'decent-elements'),
				],
			]
		);
		...
		$this->add_control(
			'meta_icon',
			[
				'label'            => esc_html__('Meta Icon', 'decent-elements'),
		...
		$this->add_control(
			'show_author',
			[
				'label'     => esc_html__('Show Author', 'decent-elements'),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => esc_html__('Show', 'decent-elements'),
				'label_off' => esc_html__('Hide', 'decent-elements'),
				'default'   => 'no',
		...
		$this->add_control(
			'show_taxonomy',
			[
				'label'     => esc_html__('Show Category', 'decent-elements'),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => esc_html__('Show', 'decent-elements'),
				'label_off' => esc_html__('Hide', 'decent-elements'),
				'default'   => 'yes',
		...
		$this->add_control(
			'post_taxonomy',
			[
				'label'       => esc_html__('Taxonomy', 'decent-elements'),
		...
		$this->add_control(
			'show_date',
			[
				'label'     => esc_html__('Show Date', 'decent-elements'),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => esc_html__('Show', 'decent-elements'),
				'label_off' => esc_html__('Hide', 'decent-elements'),
				'default'   => 'yes',
		...
		$this->add_control(
			'show_date_image',
			[
				'label'     => esc_html__('Show Date On Image', 'decent-elements'),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => esc_html__('Show', 'decent-elements'),
				'label_off' => esc_html__('Hide', 'decent-elements'),
				'default'   => 'yes',
		...
		$this->add_control(
			'show_read_time',
			[
				'label'     => esc_html__('Show Read Time', 'decent-elements'),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => esc_html__('Show', 'decent-elements'),
				'label_off' => esc_html__('Hide', 'decent-elements'),
				'default'   => 'yes',
		...
		$this->add_control(
			'show_comment',
			[
				'label'     => esc_html__('Show Comment', 'decent-elements'),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => esc_html__('Show', 'decent-elements'),
				'label_off' => esc_html__('Hide', 'decent-elements'),
				'default'   => 'no',
		...
		$this->start_controls_section(
			'section_button',
			[
				'label'     => esc_html__('Button', 'decent-elements'),
				'tab'       => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'preset_layout!' => ['3'],
				]
		...
		$this->add_control(
			'show_read_more',
			[
				'label'     => esc_html__('Read More', 'decent-elements'),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => esc_html__('Show', 'decent-elements'),
				'label_off' => esc_html__('Hide', 'decent-elements'),
				'default'   => 'yes',
		...
		$this->add_control(
			'read_more_text',
			[
				'label'       => esc_html__('Read More Text', 'decent-elements'),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => [
					'active' => true,
				],
				'default'     => esc_html__('Discover more', 'decent-elements'),
		...
		$this->add_control(
			'selected_icon',
			[
				'label'            => esc_html__('Icon', 'decent-elements'),
				'type'             => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon',
				'skin'             => 'inline',
				'label_block'      => false,
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'left'  => [
						'title' => esc_html__('Before', 'decent-elements'),
						'icon'  => 'eicon-h-align-left',
					],
					'right' => [
						'title' => esc_html__('After', 'decent-elements'),
						'icon'  => 'eicon-h-align-right',
					],
				],
				'condition' => ['show_read_more' => 'yes'],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Thumbnail', 'decent-elements'),
		...
		$this->add_responsive_control(
			'object-fit',
			[
				'label'     => esc_html__('Object Fit', 'decent-elements'),
				'type'      => Controls_Manager::SELECT,
				'condition' => [
					'thumb_height[size]!' => '',
				],
				'options'   => [
					''        => esc_html__('Default', 'decent-elements'),
					'fill'    => esc_html__('Fill', 'decent-elements'),
					'cover'   => esc_html__('Cover', 'decent-elements'),
					'contain' => esc_html__('Contain', 'decent-elements'),
				],
				'default'   => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			'object-position',
			[
				'label'     => esc_html__('Object Position', 'decent-elements'),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'center center' => esc_html__('Center Center', 'decent-elements'),
					'center left'   => esc_html__('Center Left', 'decent-elements'),
					'center right'  => esc_html__('Center Right', 'decent-elements'),
					'top center'    => esc_html__('Top Center', 'decent-elements'),
					'top left'      => esc_html__('Top Left', 'decent-elements'),
					'top right'     => esc_html__('Top Right', 'decent-elements'),
					'bottom center' => esc_html__('Bottom Center', 'decent-elements'),
					'bottom left'   => esc_html__('Bottom Left', 'decent-elements'),
					'bottom right'  => esc_html__('Bottom Right', 'decent-elements'),
				],
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Bottom Spacing', 'decent-elements'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', '%', 'em', 'rem', 'vh', 'custom'],
				'range'      => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Content Wrapper', 'decent-elements'),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__('Title Typography', 'decent-elements'),
		...
		$this->start_controls_tab(
			'tab_title_normal',
			[
				'label' => esc_html__('Normal', 'decent-elements'),
			]
		);
		...
		$this->add_control(
			'title_color',
			[
				'label'     => esc_html__('Title Color', 'decent-elements'),
		...
		$this->start_controls_tab(
			'tab_tile_hover',
			[
				'label' => esc_html__('Hover', 'decent-elements'),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Excerpt', 'decent-elements'),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_excerpt' => 'yes',
				],
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Wrapper Padding', 'decent-elements'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', 'em', 'rem', 'custom'],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Wrapper BG Color', 'decent-elements'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'meta_icon_size',
			[
				'label'      => esc_html__('Icon Size', 'decent-elements'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', 'rem'],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'meta_icon_gap',
			[
				'label'      => esc_html__('Icon Gap', 'decent-elements'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', 'rem'],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'meta_gap',
			[
				'label'      => esc_html__('Meta Between Gap', 'decent-elements'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', 'rem', 'custom'],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Separator BG Color', 'decent-elements'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Separator Height', 'decent-elements'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', 'rem', 'custom'],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'meta_year_color',
			[
				'label'     => esc_html__('Year Color', 'decent-elements'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Date Meta', 'decent-elements'),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'preset_layout' => '9'
				]
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Author', 'decent-elements'),
				'tab'       => Controls_Manager::TAB_STYLE,
		...
		$this->add_control(
			'author_name_color',
			[
				'label'     => esc_html__('Name Color', 'decent-elements'),
				'type'      => Controls_Manager::COLOR,
				'separator' => 'before',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => esc_html__('Name Typography', 'decent-elements'),
	...
	protected function register_design_layout_controls()
	{
		...
		$this->add_responsive_control(
			'column_gap',
			[
				'label'      => esc_html__('Columns Gap', 'decent-elements'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', 'rem', 'custom'],
				'default'    => [
					'size' => 30,
		...
		$this->add_responsive_control(
			'row_gap',
			[
				'label'      => esc_html__('Rows Gap', 'decent-elements'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', 'rem', 'custom'],
				'default'    => [
					'size' => 35,
		...
		$this->add_responsive_control(
			'post_margin',
			[
				'label'      => esc_html__('Margin', 'decent-elements'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%', 'em', 'rem', 'custom'],
				'selectors'  => [
		...
		$this->add_control(
			'el_hover_effects',
			[
				'label'        => esc_html__('Hover Effect', 'decent-elements'),
				'description'  => esc_html__('This effect will work only on image tags.', 'decent-elements'),
				'type'         => Controls_Manager::SELECT,
				'default'      => 'effect-zoom-in',
				'options'      => [
					''                => esc_html__('None', 'decent-elements'),
					'effect-zoom-in'  => esc_html__('Zoom In', 'decent-elements'),
					'effect-zoom-out' => esc_html__('Zoom Out', 'decent-elements'),
					'left-move'       => esc_html__('Left Move', 'decent-elements'),
					'right-move'      => esc_html__('Right Move', 'decent-elements'),
				],
	...
	public function register_pagination_section_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					''                      => esc_html__('None', 'decent-elements'),
					'numbers_and_prev_next' => esc_html__('Numbers', 'decent-elements').' + '.esc_html__('Previous/Next', 'decent-elements'),
					'load_more'             => esc_html__('Load More', 'decent-elements'),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Page Limit', 'decent-elements'),
				'default'   => '5',
				'condition' => [
					'pagination_type' => 'numbers_and_prev_next',
				],
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Shorten', 'decent-elements'),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => '',
				'condition' => [
					'pagination_type' => 'numbers_and_prev_next',
		...
		$this->add_control(
			...
			[
				'label'            => esc_html__('Previous Arrow Icon', 'decent-elements'),
				'type'             => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon',
				'skin'             => 'inline',
				'label_block'      => false,
		...
		$this->add_control(
			...
			[
				'label'            => esc_html__('Next Arrow Icon', 'decent-elements'),
				'type'             => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon',
				'skin'             => 'inline',
				'label_block'      => false,
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Spacing Top', 'decent-elements'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', 'rem', 'custom'],
				'default'    => [
					'size' => 70,
		...
		$this->add_control(
			'load_more_btn_text',
			[
				'label'       => esc_html__('Text', 'decent-elements'),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__('Load More Works', 'decent-elements'),
				'placeholder' => esc_html__('Load More', 'decent-elements'),
				'condition'   => [
					'pagination_type' => 'load_more',
				],
			]
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__('Border', 'decent-elements'),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Icon Color', 'decent-elements'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Icon Hover Color', 'decent-elements'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Wrapper', 'decent-elements'),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	public function register_slider_section_controls()
	{
		$this->start_controls_section(
			'section_slider',
			[
				'label' => esc_html__('Slider Settings', 'decent-elements'),
			]
		);
		$this->add_control(
			'enable_slider',
			[
				'label'        => esc_html__('Enable Slider', 'decent-elements'),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'freeMode',
			[
				'label'        => esc_html__('Free Mode', 'decent-elements'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Yes', 'decent-elements'),
				'label_off'    => esc_html__('No', 'decent-elements'),
				'return_value' => 'yes',
		...
		$this->add_control(
			'responsive',
			[
				'label'        => esc_html__('Responsive', 'decent-elements'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Yes', 'decent-elements'),
				'label_off'    => esc_html__('No', 'decent-elements'),
				'return_value' => 'yes',
		...
		$repeater->add_control(
			'device_width',
			[
				'label'   => __('Max Width', 'decent-elements'),
				'type'    => Controls_Manager::NUMBER,
				'min'     => 0,
				'max'     => 10000,
				'step'    => 1,
		...
		$repeater->add_control(
			'slidesPerView',
			[
				'label'       => __('SlidesPerView', 'decent-elements'),
				'type'        => Controls_Manager::NUMBER,
				'min'         => 0,
				'max'         => 200,
				'step'        => 1,
				'default'     => 1,
				'description' => __('Set zero for  auto (or) Set any number which you want to display.', 'decent-elements'),
			]
		);
		$repeater->add_control(
			'slidesPerGroup',
			[
				'label'   => __('Slides To Scroll', 'decent-elements'),
				'type'    => Controls_Manager::NUMBER,
				'min'     => 1,
				'max'     => 200,
				'step'    => 1,
		...
		$repeater->add_control(
			'spaceBetween',
			[
				'label'   => __('SpaceBetween', 'decent-elements'),
				'type'    => Controls_Manager::NUMBER,
				'min'     => 0,
				'max'     => 200,
				'step'    => 1,
		...
		$repeater->add_control(
			'slidesPerGroupSkip',
			[
				'label'   => __('slidesPerGroupSkip', 'decent-elements'),
				'type'    => Controls_Manager::NUMBER,
				'min'     => 1,
				'max'     => 20,
				'step'    => 1,
		...
		$repeater->add_control(
			'slidesFreeMode',
			[
				'label'        => esc_html__('FreeMode', 'decent-elements'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Yes', 'decent-elements'),
				'label_off'    => esc_html__('No', 'decent-elements'),
				'return_value' => 'yes',
		...
		$this->add_control(
			'resposive_settings',
			[
				'label'       => __('Responsive', 'decent-elements'),
				'show_label'  => false,
		...
		$this->add_control(
			'slider_overflow',
			[
				'label'     => esc_html__('Overflow', 'decent-elements'),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'hidden',
				'options'   => [
					'hidden'  => esc_html__('Hidden', 'decent-elements'),
					'visible' => esc_html__('Visible', 'decent-elements'),
				],
				'condition' => [
					'enable_slider' => ['yes']
				]
	...
	<?php endif; ?>
		...
		if ('numbers_and_prev_next' === $settings['pagination_type']) {
			$paginate_args = [
				...
				'before_page_number' => '<span class="elementor-screen-only">'.esc_html__('Page', 'decent-elements').'</span>',
			];
            ...
            <nav <?php $this->print_render_attribute_string('pagination'); ?>
                    aria-label="<?php esc_attr_e('Pagination', 'decent-elements'); ?>">
	...
	protected function post_read_time()
	{
		...
		$read_time = $read_time > 1 ? $read_time.' '.__('min read', 'decent-elements') : $read_time.' '.__('min read', 'decent-elements');
	...
	protected function render_read_more()
	{
		...
		/* translators: %s: Post title. */
			esc_attr__('Read more about %s', 'decent-elements'),
			get_the_title()
		);
