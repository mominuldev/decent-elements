...
trait Posts_Query
{
	...
	protected function register_query_controls()
	{
		$this->start_controls_section(
			'section_query',
			[
				'label' => esc_html__('Query', 'decent-elements'),
		...
		$this->add_control(
			'query_type',
			[
				'label'   => esc_html__('Query Type', 'decent-elements'),
				'type'    => Controls_Manager::SELECT,
				'default' => 'custom',
				'options' => apply_filters('fc_widget_wp_query_type', [
					'custom'  => esc_html__('Custom', 'decent-elements'),
					'archive' => esc_html__('Archive', 'decent-elements'),
					'related' => esc_html__('Related', 'decent-elements')
				]),
			]
		);
		...
		$this->add_control(
			'post_type',
			[
				'label'     => esc_html__('Source', 'decent-elements'),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'post',
		...
		$this->add_control(
			'posts_offset',
			[
				'label'       => esc_html__('Posts Offset', 'decent-elements'),
				'type'        => Controls_Manager::NUMBER,
				'description' => esc_html__('Number of posts to skip', 'decent-elements'),
			]
		);
		...
		$this->start_controls_tab(
			'query_include',
			[
				'label'     => esc_html__('Include', 'decent-elements'),
		...
		$this->add_control(
			'include',
			[
				'label'       => esc_html__('Include By', 'decent-elements'),
				'type'        => Controls_Manager::SELECT2,
				'label_block' => true,
				'multiple'    => true,
				'options'     => [
					'terms'   => esc_html__('Term', 'decent-elements'),
					'authors' => esc_html__('Author', 'decent-elements'),
				],
				'condition'   => ['query_type' => 'custom'],
			]
		);
		...
		$this->add_control(
			'include_term_ids',
			[
				'label'       => esc_html__('Term', 'decent-elements'),
				'description' => esc_html__('Add coma separated, terms id', 'decent-elements'),
				'placeholder' => esc_html__('All', 'decent-elements'),
				'label_block' => true,
				'ai'          => [
					'active' => false,
				],
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_html__('Add separated, authors ID', 'decent-elements'),
				'placeholder' => esc_html__('All', 'decent-elements'),
				'label_block' => true,
				'ai'          => [
					'active' => false,
		...
		$this->start_controls_tab(
			'query_exclude',
			[
				'label'     => esc_html__('Exclude', 'decent-elements'),
				'condition' => ['query_type' => 'custom'],
			]
		);
		...
		$this->add_control(
			'exclude',
			[
				'label'       => esc_html__('Exclude By', 'decent-elements'),
				'type'        => Controls_Manager::SELECT2,
				'label_block' => true,
				'multiple'    => true,
				'options'     => [
...
//			'post_format',
//			[
//				'label'     => esc_html__( 'Post Format', 'decent-elements' ),
//				'type'      => Controls_Manager::SELECT2,
//				'default'   => [],
//				'multiple'  => true,
//				'options'   => [
//					'post-format-image'   => esc_html__( 'Image', 'decent-elements' ),
//					'post-format-video'   => esc_html__( 'Video', 'decent-elements' ),
//					'post-format-audio'   => esc_html__( 'Audio', 'decent-elements' ),
//					'post-format-gallery' => esc_html__( 'Gallery', 'decent-elements' ),
//				],
//				'condition' => [ 'query_type' => [ 'custom' ] ],
//			]
//		);
		...
		$this->add_control(
			'post_categories',
			[
				'label'     => esc_html__('Post Categories', 'decent-elements'),
				'type'      => Controls_Manager::SELECT2,
				'default'   => [],
				'multiple'  => true,
		...
		$this->add_control(
			'post_tags',
			[
				'label'     => esc_html__('Post Tags', 'decent-elements'),
				'type'      => Controls_Manager::SELECT2,
				'default'   => [],
				'multiple'  => true,
		...
		$this->add_control(
			'post_date',
			[
				'label'     => esc_html__('Date', 'decent-elements'),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'anytime',
				'options'   => [
					'anytime'  => esc_html__('All', 'decent-elements'),
					'-1 day'   => esc_html__('Past Day', 'decent-elements'),
					'-3 day'   => esc_html__('Past 3 Day', 'decent-elements'),
					'-1 week'  => esc_html__('Past Week', 'decent-elements'),
					'-2 week'  => esc_html__('Past Two Weeks', 'decent-elements'),
					'-1 month' => esc_html__('Past Month', 'decent-elements'),
					'-3 month' => esc_html__('Past Quarter', 'decent-elements'),
					'-1 year'  => esc_html__('Past Year', 'decent-elements'),
				],
				'condition' => [
					'query_type' => [
						'custom',
		...
		$this->add_control(
			'post_order_by',
			[
				'label'     => esc_html__('Order By', 'decent-elements'),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'date',
				'options'   => [
					'date'          => esc_html__('Date', 'decent-elements'),
					'title'         => esc_html__('Title', 'decent-elements'),
					'menu_order'    => esc_html__('Menu Order', 'decent-elements'),
					'modified'      => esc_html__('Last Modified', 'decent-elements'),
					'comment_count' => esc_html__('Comment Count', 'decent-elements'),
					'rand'          => esc_html__('Random', 'decent-elements'),
				],
				'condition' => ['query_type' => 'custom'],
			]
		);
		...
		$this->add_control(
			'post_order',
			[
				'label'     => esc_html__('Order', 'decent-elements'),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'desc',
				'options'   => [
					'asc'  => esc_html__('ASC', 'decent-elements'),
					'desc' => esc_html__('DESC', 'decent-elements'),
				],
				'condition' => ['query_type' => 'custom'],
			]
		);
		...
		$this->add_control(
			'post_sticky_ignore',
			[
				'label'        => esc_html__('Ignore Sticky Posts', 'decent-elements'),
