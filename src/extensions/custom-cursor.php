...
class Decent_Elements_Custom_Cursor_Extension
{
	 ...
	 * module definition, which declares the `de-custom-cursor` stylesheet and
	 * script plus its `gsap` dependency. GSAP is now served from the copy that
	 * ships in assets/vendors/ rather than fetched from cdnjs at runtime.
	 *
	 * The old guard here also used \Elementor\Plugin::$instance->db, which has
	 * been deprecated since Elementor 3.1 in favour of the documents manager.
	 */
