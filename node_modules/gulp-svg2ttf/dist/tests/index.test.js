...
describe('gulp-svg2ttf conversion', () => {
    ...
    describe('in buffer mode', () => {
        ...
        test('should work', async () => {
            ...
            expect(objs[0].contents.toString('utf-8')).toEqual(ttf.toString('utf-8'));
        });
        ...
        test('should work with the clone option', async () => {
            ...
            expect(objs[0].contents.toString('utf-8')).toEqual(await readFile(filename + '.svg', 'utf-8'));
            expect(objs[1].path).toContain(filename + '.ttf');
            expect(objs[1].contents.toString('utf-8')).toEqual(ttf.toString('utf-8'));
        });
    ...
    describe('in stream mode', () => {
        test('should work', async () => {
            ...
            expect(objs.length).toEqual(1);
            expect(objs[0].path).toContain(filename + '.ttf');
            objs[0].contents.pipe(contentStream);
        ...
        test('should work with the clone option', async () => {
            ...
            expect(Buffer.concat(await contentResult1).toString('utf-8')).toEqual(await readFile(filename + '.svg', 'utf-8'));
